<div class="relative overflow-hidden">
  <div class="">
    <div class="relative z-10 py-8 bg-gray-900 sm:py-12 md:py-16 lg:max-w-2xl lg:w-full lg:py-20">
      <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        <div class="sm:text-center lg:text-left">
          <h2 class="text-4xl tracking-tight leading-10 font-extrabold text-gray-200 sm:text-5xl sm:leading-none md:text-6xl">
            Data to enrich your
            <br class="xl:hidden" />
